...
public class VM2 implements Comparable<VM2>{
    ...
    @Override
	public int compareTo(VM2 otherVM) {
		if(this.primeNumbers.size() == otherVM.primeNumbers.size()) {
			return 0;
		}
		return this.primeNumbers.size() > otherVM.primeNumbers.size() ? 1 : -1;
	}

    public void mutateMem(int index, int operation) {
